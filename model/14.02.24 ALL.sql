...
-- Listage des données de la table registros.events : ~8 rows (environ)
DELETE FROM `events`;
INSERT INTO `events` (`id_event`, `name_event`, `date`, `time_init`, `time_end`, `place`, `details`, `comite_id`, `siblings`, `friends`) VALUES
	(1, 'TESTE EVENT234234', '2024-02-13', '09:30:00', '23:15:48', 'iglesia', 'nose aun', 5, '123', '1243'),
	...
	(4, 'TESTE EVENT234234', '2024-02-14', '12:45:00', NULL, 'ch. de tour 2', NULL, 1, '23', '23'),
	(11, 'test2', '2024-02-14', '12:03:03', NULL, NULL, NULL, 1, '324', '234'),
	(18, 'testmodif', '2024-02-20', '12:12:00', NULL, NULL, NULL, 5, '123', '123'),
	(20, 'TESTE EVENT234234', '2024-02-29', '12:34:00', NULL, NULL, NULL, 4, '234', '411'),
	(21, 'TESTE EVENT', '2024-04-26', '08:00:00', NULL, NULL, NULL, 5, '0', '0');
...
-- Listage des données de la table registros.services : ~16 rows (environ)
...
-- Listage des données de la table registros.users : ~7 rows (environ)
DELETE FROM `users`;
...
-- Listage des données de la table registros.users_has_services : ~19 rows (environ)
